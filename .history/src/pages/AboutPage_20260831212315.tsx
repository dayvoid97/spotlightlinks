        ...
        {isMachine ? (
          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <p>
                We make that recommendation yours — cited, quoted, and spelled correctly — with a
                focus on Google Gemini and ChatGPT. Not with text ads. With the facts about your
