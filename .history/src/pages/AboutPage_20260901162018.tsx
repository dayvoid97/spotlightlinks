      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        {isMachine ? (
          ...
          <div className="signage">
            ...
            <section className="border-ink border-t-2 py-14">
              <FaqSection
                items={ABOUT_FAQS}
                id="about-faq"
...
const SIGNAGE_BUTTON =
  'inline-flex items-center justify-center gap-2 border-2 border-ink bg-ink px-6 py-3.5 ' +
  'text-sm font-bold uppercase tracking-[0.08em] text-surface transition hover:bg-brand hover:border-brand'
...
function Masthead() {
  return (
    <header className="pt-8">
      <div className="border-ink flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1 border-b-2 pb-2">
      ...
      <h2 className="signage-display text-ink mt-10">About</h2>
...
function AdvisoryBand() {
  return (
    <section className="bg-ink text-surface px-6 py-10 sm:px-10 sm:py-12">
      <p className="signage-label text-surface/60">Notice to business owners</p>
      ...
      <p className="text-surface/70 mt-4 max-w-3xl text-sm leading-relaxed">
        If an engine does not know you exist, it recommends the business it does know. That decision
        happens once, invisibly, before a customer ever reaches your door.
      </p>
    </section>
  )
}
...
function EngineFocusSection() {
  return (
    <section id="engines" className="border-ink scroll-mt-24 border-b-2 py-14">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_20rem]">
        ...
        <div className="border-ink h-fit border-2 p-6">
        ...
        {SERVICES.map((service, i) => {
          ...
          return (
            <article
              key={service.slug}
              id={service.slug}
              className="border-ink scroll-mt-24 border-t-2 pt-7"
            >
...
function ProbeSection() {
  return (
    <section id="probe" className="border-ink scroll-mt-24 border-t-2 py-14">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.6fr_1fr]">
        ...
        <div className="border-ink h-fit border-2">
...
function DeploymentSection() {
  ...
  return (
    <section id="deployment" className="border-ink scroll-mt-24 border-t-2 py-14">
  ...
  return (
    <section className="border-ink border-t-2 py-14">
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-10 gap-y-10 sm:grid-cols-3">
        {steps.map((s) => (
          <div key={s.step} className="border-ink border-t-2 pt-5">
            <span className="signage-bullet" aria-hidden="true">
              {s.step}
            </span>
  ...
  return (
    <section className="border-ink border-t-2 py-14">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.4fr]">
        ...
        <dl className="border-ink border-t-2">
          {rows.map((row) => (
            <div
              key={row.term}
...
function ClosingBand() {
  return (
    <section className="mb-16">
      <div className="bg-ink text-surface px-6 py-12 sm:px-10 sm:py-14">
        <p className="signage-label text-surface/60">Next step</p>
        <h2 className="mt-4 max-w-3xl text-3xl leading-[1.06] sm:text-5xl">
          Find out what AI says about you today.
        </h2>
        <p className="text-surface/70 mt-5 max-w-2xl leading-relaxed">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            to="/get-started"
            className="border-surface bg-surface text-ink hover:bg-brand hover:border-brand inline-flex items-center justify-center gap-2 border-2 px-6 py-3.5 text-sm font-bold uppercase tracking-[0.08em] transition hover:text-white"
          >
            Build my profile <ArrowRight className="size-4" />
          </Link>
          <Link
            to="/compare"
            className="border-surface/50 text-surface hover:bg-surface hover:text-ink inline-flex items-center justify-center gap-2 border-2 px-6 py-3.5 text-sm font-bold uppercase tracking-[0.08em] transition"
          >
            See how we compare
          </Link>
        </div>
