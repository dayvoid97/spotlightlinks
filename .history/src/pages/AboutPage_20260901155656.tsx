          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <h1 className="text-ink max-w-4xl text-4xl font-semibold sm:text-5xl">
                Spotlight Links get your businesses recommended and cited by name when a cusotmer is
                searching online. We focus on devilering results on Google Gemini and ChatGPT.
              </h1>
              ...
              <p>
                ...
                in the business of seeling ads. We do not sell backlinks either. Spotlight links
                builds your businesss schema and digital assets into a block that is easily and
                readily accessible to answer engines.
              </p>
            </header>
