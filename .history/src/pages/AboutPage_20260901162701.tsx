    ...
    <header className="pt-8">
      ...
      <div className="mt-8 grid max-w-5xl gap-x-12 gap-y-5 pb-12 sm:grid-cols-2">
        ...
        <p className="text-ink-70 text-base leading-relaxed">
          ...
          your facts, your schema, and your digital assets into a block that answer engines can
          read, trust, and quote — the state of the art in visibility, pointed at the place your
