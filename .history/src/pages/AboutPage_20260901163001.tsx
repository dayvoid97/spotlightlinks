  ...
  return (
    <header className="pt-8">
      ...
      <p className="text-ink mt-10 max-w-4xl text-2xl font-bold leading-[1.1] tracking-[-0.025em] sm:text-4xl">
        Spotlight Links gets your business recommended and cited by name when a customer asks Google
        Gemini or ChatGPT.
      </p>

      <div className="mt-8 grid max-w-5xl gap-x-12 gap-y-5 pb-12 sm:grid-cols-2">
        <p className="text-ink-70 text-base leading-relaxed">
          Your customers have stopped scrolling google search results — they ask an AI chatbot like
          ChatGPT or Google Gemini for a activity or a service recommendation and act on the answer
          they get back. When someone goes to Google Search or ChatGPT looking for a service like
          yours, one question decides everything: does your business show up in that answer?
        </p>
        <p className="text-ink-70 text-base leading-relaxed">
          Spotlight Links does not sell ads, and we do not sell backlinks. Spotlight Links builds
          your facts, your schema, and your digital assets into a AI engine indexable block that
          answer engines can read, trust, and quote — the state of the art in visibility, pointed at
          the place your customers are actually searching.
        </p>
      </div>
    </header>
  )
  ...
  return (
    <section className="bg-brand px-6 py-12 text-white sm:px-10 sm:py-14">
      ...
      <p className="mt-4 max-w-4xl text-2xl font-bold leading-[1.12] tracking-[-0.025em] sm:text-3xl">
        Your customers are no longer searching. They are looking for answers and recommendations.
      </p>
