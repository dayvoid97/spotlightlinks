...
import { ArrowRight, Check, Rocket, Search, Network } from 'lucide-react'
import { PublicHeader, PublicFooter } from '../components/PublicChrome'
import { Button } from '../components/ui/Button'
import { SERVICES, DEPLOYMENT_NOTE } from '../lib/marketing'
    ...
    () => ({
      ...
      sections: [
        ...
        })),
        {
          ...
          content: `- AEO/GEO subscription: $79/month Starter Prober (2 managed assets, up to 4 audits per asset per month), $199 Growth, $299 Scale, $599 Enterprise.\n- ${DEPLOYMENT_NOTE}\n- Contact: support@spotlightlinks.com`,
        },
      ],
    }),
    []
          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <p className="text-ink-50 mt-5 max-w-3xl text-lg leading-relaxed">
                Spotlight Links is a New York agency working on one problem: your customers now ask
                an AI assistant instead of scrolling ten blue links, and the assistant returns a
                single recommendation. We make that recommendation yours — cited, quoted, and
                spelled correctly — across ChatGPT, Google Gemini, Anthropic Claude, and Perplexity.
                Not with text ads. With the facts about your business, published in a form a model
                can actually read.
              </p>
            </header>
