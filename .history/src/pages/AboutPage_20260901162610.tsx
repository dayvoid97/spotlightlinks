    ...
    <header className="pt-8">
      ...
      <div className="mt-8 grid max-w-5xl gap-x-12 gap-y-5 pb-12 sm:grid-cols-2">
        <p className="text-ink-70 text-base leading-relaxed">
          Your customers have stopped scrolling google search results — they ask an assistant for a
          recommendation and act on the answer they get back. When someone goes to Google Search or
          ChatGPT looking for a service like yours, one question decides everything: does your
          business show up in that answer?
        </p>
        <p className="text-ink-70 text-base leading-relaxed">
