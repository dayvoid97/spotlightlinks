          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <p>
                ...
                ensure your business is discovered when customers are searching online.. Not with
                text ads. With the facts about your business, published in a form a model can
                actually read.
              </p>
            </header>
