          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <p className="text-ink-50 mt-5 max-w-3xl text-lg leading-relaxed">
                ...
                links, and the assistant returns a single recommendation. We make that
                recommendation yours — cited, quoted, and spelled correctly — with a focus on Google
                Gemini and ChatGPT. Not with text ads. With the facts about your business, published
                in a form a model can actually read.
              </p>
            </header>
