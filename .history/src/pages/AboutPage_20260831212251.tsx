          ...
          <>
            <header className="border-line border-b py-12 sm:py-16">
              ...
              <p className="text-ink-50 mt-5 max-w-3xl text-lg leading-relaxed">
                ...
                recommendation for a service or a place to visit - does your business show up or
                not? We make that recommendation yours — cited, quoted, and spelled correctly — with
                a focus on Google Gemini and ChatGPT. Not with text ads. With the facts about your
