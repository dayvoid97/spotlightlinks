      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-16 sm:px-6 sm:py-24 md:grid-cols-2 md:py-28">
        <div>
          <h1 className="text-ink text-4xl font-semibold leading-[1.1] sm:text-5xl">
            Welcome to your <span className="text-brand">AI search visibility</span> console
          </h1>
          <p className="text-ink-50 mt-5 max-w-md text-base">
        ...
        <div className="relative flex items-center justify-center md:justify-end">
          <div className="bg-brand/25 pointer-events-none absolute right-0 size-72 rounded-full blur-[100px] md:size-96" />
          <img
            src="/679.png"
            alt=""
  ...
  return (
    <footer className="border-line border-t">
      <div className="text-ink-30 mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-6 text-xs sm:px-6">
        ...
        <span> AI search visibility console</span>
      </div>
    </footer>
  )
}
