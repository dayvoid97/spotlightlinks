      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 ">
        <div className="flex max-w-3xl flex-col items-center">
          ...
          <p>
            ...
            whether or not your business shows up in their answers and recommendations.
          </p>

          {/* High-Converting Interactive Input Bar */}
          <p className="text-muted-foreground mt-100 text-sm">
            Takes about 10 minutes: fill out the form, pay $79, run your first probe, BE AMAZED!
          </p>
