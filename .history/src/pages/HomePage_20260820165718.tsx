    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 ">
        <div className="flex max-w-3xl flex-col items-center">
          ...
          <p>
            Your customers user AI everyday for answers and local service recommendations. Discover
            whether or not your business shows up in these answers and recommendations.
          </p>
          <p className="text-ink-50 mt-6 max-w-2xl text-lg sm:text-xl"> Takes 10 minutes and 79$</p>
