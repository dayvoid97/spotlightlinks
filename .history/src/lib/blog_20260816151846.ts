...
export interface BlogPost {
  ...
  /** Raw path from frontmatter (e.g. "/media/x.png") — may not exist in this project. */
  image: string | null
}
...
export async function fetchBlogPosts(): Promise<BlogPost[]> {
  const indexRes = await fetch('/blogcopy/index.json')
...
export function blogPostUrl(slug: string): string {
  return `https://spotlightlinks.com/blogsets/${slug}`
}
