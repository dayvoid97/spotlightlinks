...
export const SERVICE_AREA = {
  ...
  blurb:
    'Spotlight Links serves local and brick-and-mortar businesses across New York City — hardware stores, pizzerias, restaurants, takeout counters, and discount shops — with AI and search visibility audits scoped to their own ZIP code and surrounding neighborhoods.',
  neighborhoods: [
    'Astoria',
    'Jackson Heights',
    'Elmhurst',
