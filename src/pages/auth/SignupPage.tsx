...
export default function SignupPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      await signup(form)
      // If they came from the public onboarding funnel, resume there with their
      // parked intake; otherwise land on the dashboard. See onboarding-draft.ts.
      navigate(hasOnboardingDraft() ? '/clients/new' : '/dashboard', { replace: true })
    } catch (err) {
