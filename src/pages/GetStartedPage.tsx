  ...
  return (
    <div className="bg-surface min-h-screen">
      ...
      <main className="mx-auto max-w-2xl space-y-6 px-4 py-10 sm:px-6">
        <Link to="/" className="flex items-center gap-1.5 text-sm text-ink-50 hover:text-ink-70">
        ...
        <div>
          ...
          <p className="text-ink-50 mt-1 text-sm">
            ...
            you're ready to generate the audit question set, you'll create a free account to save it.
          </p>
        </div>
