  ...
  return (
    <>
      <Routes>
        ...
        {/* Render 404 in place rather than redirecting to /404: a redirect
          throws away the URL the visitor (or crawler) actually asked for, so
          nobody can see which link broke and every miss looks like the same
          page. */}
